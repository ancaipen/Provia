...
require '/home/provia/public_html/www.provia.com/modules/mod_provia_wtb/ajax/phpmailer/Exception.php';
require '/home/provia/public_html/www.provia.com/modules/mod_provia_wtb/ajax/phpmailer/PHPMailer.php';
require '/home/provia/public_html/www.provia.com/modules/mod_provia_wtb/ajax/phpmailer/SMTP.php';
...
function get_locations($zipcode, $customertype, $entrydoors, $stormdoors, $windows_vinyl, $windows_storm, $vinylpatiodoors, $siding, $stone, $roofing, $platiumn, $certified, $visualization, $displaygroup)
{
	...
	if(isset($xml_data))
	{
		...
		if($rowCount > 0)
		{
			...
			$html .= '<h3><a href="javascript:void(0);" id="authorized-contractors-button"><img src="/modules/mod_provia_wtb/images/down-128.png" width="25" border="0" /> Authorized Retailers</a></h3>';
...
function get_result_html($child, $rowCount, $type = 'all', $idx_count = 0)
{
	...
	{
		//$html .= '<img class="certification tooltip_wtb" src="/modules/mod_provia_wtb/images/platinum_dealer_icon.png" alt="Platinum Dealer" title="Platinum Dealer - ProVia' ."'". 's performance-based recognition program for those who have demonstrated the highest level of commitment to selling and installing our products." />';
		
		$tooltip_id = 'tooltipp_wtb_'.$rowCount.'_'.$type;
		$html .= '<img class="certification tooltip_wtb" src="/modules/mod_provia_wtb/images/platinum_dealer_icon.png" alt="Visualization" data-tooltip-content="#'.$tooltip_id.'" />';
	...
	*/
	...
	if($html_certification != "")
	{
		...
		$html .= '<img class="certification tooltip_wtb" src="/modules/mod_provia_wtb/images/certified_installer_icon.png" alt="Certified Installed" data-tooltip-content="#'.$tooltip_id.'" />';
	...
	if(trim($child->UsesVisualizationTools) == "true")
	{
		...
		$html .= '<img class="certification tooltip_wtb" src="/modules/mod_provia_wtb/images/product_vis_icon.png" alt="Visualization" data-tooltip-content="#'.$tooltip_id.'" />';
