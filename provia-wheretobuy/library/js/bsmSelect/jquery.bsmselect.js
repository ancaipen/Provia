    ...
    BsmSelect.prototype = {
        ...
        */
        buildDom: function () {
            ...
            this.$msg = $('<span>', { 'class': o.msgClass, html: o.emptyMsg });
        ...
        : $('<' + o.listType + '>', { id: o.listClass + this.uid });
            ...
            console.log(this.$list.delegate('.' + o.removeClass));
      ...
      isDisabled = $origOpt.is(':disabled');
            ...
            if (isSelected && !isDisabled) {
                ...
                this.$msg.html(this.options.selectedMsg);
        ...
        */
        ...
        .data('bsm-option', $bsmOpt);
            ...
            if (o.hasPriority) {
                $item.find("a").before($('<input>', { title: 'Set as Priority', type: 'checkbox', change: function () { $origOpt.data("isPriority", $(this).attr("checked")); } }));
                $item.find("input").attr("checked", $origOpt.data("isPriority"));
            }

            this.$msg.html(o.selectedMsg);
        ...
        */
        dropListItem: function ($item) {
            ...
            if (this.$select.find("option:disabled").length == 0)
                this.$msg.html(this.options.emptyMsg);
        },
