$.extend(inContextMgr.modals["addourcompany"].modalOptions, { showClose: true });
$.extend(inContextMgr.modals["addourcompany"].events, {
    ...
    onSave: function () {
        ...
        properties.push({ propertyName: "PageTitle", value: $("#txtPageTitle").val() });
