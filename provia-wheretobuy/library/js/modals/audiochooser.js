...
$.extend(inContextMgr.modals["audiochooser"].events, {
    onOpen: function (props) {  //define the open function
        ...
        $.each(audioItems, function (index, item) {
            ...
            $("#" + item.id).data('object', item).find("a").data("info", { modal: "editaudio", title: "Edit Audio Item", typeName: "Audio", guid: item.id }).bind("click", inContextMgr.sideTrack.openModal);
        });

        $("#addArticle").data("info", { modal: "editaudio", title: "Add Audio Item", typeName: "Audio", guid: "00000000-0000-0000-0000-000000000000", newItem: true }).bind("click", inContextMgr.sideTrack.openModal);
